function makeruns(subj)

 % This  was written by Sarah Hennessy (hennessy.sarah907@gmail.com)
...
%this script should be run PRIOR to starting the scan and prior to running nostalgia_task.m
